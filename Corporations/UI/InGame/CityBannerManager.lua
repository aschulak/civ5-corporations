...
function RefreshCityBanner(cityBanner, iActiveTeam, iActivePlayer)
	...
	if city ~= nil then
		...
		-- CORPORATIONS Start
		local corpToolTip = GetCorporationCityTooltip(player, city);
		strToolTip = strToolTip .. "[NEWLINE]----------------[NEWLINE]";		
		if corpToolTip ~= nil then						
			strToolTip = strToolTip .. corpToolTip;
		else			
			strToolTip = strToolTip .. "No corporate presence in city.";		
		end
		-- CORPORATIONS End
